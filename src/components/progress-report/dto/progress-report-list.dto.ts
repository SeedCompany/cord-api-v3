...
import { FilterField, OmitType, PaginatedList, PickType, SecuredList } from '~/common';
...
@InputType()
export abstract class ProgressReportFilters extends PickType(PeriodicReportListInput, [
  'start',
  'end',
  'parent',
]) {
