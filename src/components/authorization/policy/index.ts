...
export { ResourceGranter, DefaultResourceGranter } from './builder/resource-granter';
...
export type { AllPermissionsView, AllPermissionsOfEdgeView } from './executor/all-permissions-view';
