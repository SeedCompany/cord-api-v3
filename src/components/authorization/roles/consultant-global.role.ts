...
export const ConsultantGlobal = new DbRole({
  name: `global:${Role.Consultant}` as const,
  powers: [
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbInternshipEngagement>({
      ...
      canList: true,
      properties: [
        { propertyName: 'ceremony', permission: { }, },
        { propertyName: 'completeDate', permission: { }, },
        { propertyName: 'countryOfOrigin', permission: { }, },
        { propertyName: 'disbursementCompleteDate', permission: { }, },
        { propertyName: 'endDate', permission: { }, },
        { propertyName: 'endDateOverride', permission: { }, },
        { propertyName: 'growthPlan', permission: { }, },
        { propertyName: 'initialEndDate', permission: { }, },
        { propertyName: 'intern', permission: { }, },
        { propertyName: 'lastReactivatedAt', permission: { }, },
        { propertyName: 'lastSuspendedAt', permission: { }, },
        { propertyName: 'mentor', permission: { }, },
        { propertyName: 'methodologies', permission: { }, },
        { propertyName: 'position', permission: { }, },
        { propertyName: 'startDate', permission: { }, },
        { propertyName: 'startDateOverride', permission: { }, },
        { propertyName: 'statusModifiedAt', permission: { }, },
    ...
    new DbBaseNodeGrant<DbLanguageEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'endDate', permission: { }, },
        { propertyName: 'endDateOverride', permission: { }, },
        { propertyName: 'firstScripture', permission: { }, },
        { propertyName: 'initialEndDate', permission: { }, },
        { propertyName: 'language', permission: { }, },
        { propertyName: 'lastReactivatedAt', permission: { }, },
        { propertyName: 'lastSuspendedAt', permission: { }, },
        { propertyName: 'lukePartnership', permission: { }, },
        { propertyName: 'openToInvestorVisit', permission: { }, },
        { propertyName: 'paratextRegistryId', permission: { }, },
        { propertyName: 'pnp', permission: { }, },
        { propertyName: 'historicGoal', permission: { }, },
        { propertyName: 'sentPrintingDate', permission: { }, },
        { propertyName: 'startDate', permission: { }, },
        { propertyName: 'startDateOverride', permission: { }, },
        { propertyName: 'statusModifiedAt', permission: { }, },
        { propertyName: 'modifiedAt', permission: { }, },
        { propertyName: 'product', permission: { }, },
        { propertyName: 'status', permission: { }, },
      ],
      canDelete: false,
    }),
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      canList: true,
      properties: [
        { propertyName: 'estimatedSubmission', permission: { }, },
        { propertyName: 'step', permission: {  }, },
        { propertyName: 'name', permission: {  }, },
        { propertyName: 'status', permission: {  }, },
        { propertyName: 'departmentId', permission: {  }, },
        { propertyName: 'mouStart', permission: {  }, },
        { propertyName: 'mouEnd', permission: {  }, },
        { propertyName: 'initialMouEnd', permission: {  }, },
        { propertyName: 'stepChangedAt', permission: {  }, },
        { propertyName: 'rootDirectory', permission: {  }, },
        { propertyName: 'member', permission: {  }, },
        { propertyName: 'otherLocations', permission: {  }, },
        { propertyName: 'primaryLocation', permission: {  }, },
        { propertyName: 'marketingLocation', permission: {  }, },
        { propertyName: 'partnership', permission: {  }, },
        { propertyName: 'budget', permission: {  }, },
        { propertyName: 'modifiedAt', permission: {  }, },
        { propertyName: 'fieldRegion', permission: {  }, },
        { propertyName: 'engagement', permission: {  }, },
        { propertyName: 'sensitivity', permission: {  }, },
        { propertyName: 'tags', permission: {  }, },
        { propertyName: 'financialReportReceivedAt', permission: {  }, },
        { propertyName: 'financialReportPeriod', permission: {  }, },
        { propertyName: 'owningOrganization', permission: {  }, },
        { propertyName: 'posts', permission: {  }, },
        { propertyName: 'presetInventory', permission: {  }, },
      ],
      canDelete: false,
    }),
