...
export const ConsultantGlobal = new DbRole({
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbProduct>({
      ...
      properties: [
        { propertyName: 'mediums', permission: { }, },
        { propertyName: 'methodology', permission: { }, },
        { propertyName: 'purposes', permission: { }, },
        { propertyName: 'steps', permission: { }, },
        { propertyName: 'scriptureReferences', permission: { }, },
        { propertyName: 'produces', permission: { }, },
        { propertyName: 'scriptureReferencesOverride', permission: { }, },
        { propertyName: 'isOverriding', permission: { }, },
        { propertyName: 'describeCompletion', permission: { }, },
        { propertyName: 'progressStepMeasurement', permission: { }, },
        { propertyName: 'progressTarget', permission: { }, },
        { propertyName: 'title', permission: { }, },
        { propertyName: 'description', permission: { }, },
        { propertyName: 'unspecifiedScripture', permission: { }, },
        { propertyName: 'placeholderDescription', permission: { }, },
      ],
      canDelete: false,
    }),
