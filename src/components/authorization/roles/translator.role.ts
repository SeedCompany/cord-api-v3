...
export const Translator = new DbRole({
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbPartnership>({
      ...
      canList: false,
      properties: [
        { propertyName: 'agreement', permission: {}, },
        { propertyName: 'agreementStatus', permission: {}, },
        { propertyName: 'financialReportingType', permission: {}, },
        { propertyName: 'mou', permission: {}, },
        { propertyName: 'mouEnd', permission: {}, },
        { propertyName: 'mouEndOverride', permission: {}, },
        { propertyName: 'mouStart', permission: {}, },
        { propertyName: 'mouStartOverride', permission: {}, },
        { propertyName: 'mouStatus', permission: {}, },
        { propertyName: 'types', permission: {}, },
        { propertyName: 'organization', permission: {}, },
