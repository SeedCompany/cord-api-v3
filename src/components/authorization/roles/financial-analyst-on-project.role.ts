...
export const FinancialAnalystOnProject = new DbRole({
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbPartner>({
      ...
      properties: [
        { propertyName: 'organization', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'pointOfContact', permission: { read, write, }, },
        { propertyName: 'types', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'financialReportingTypes', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'pmcEntityCode', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'globalInnovationsClient', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'active', permission: { read, write, sensitivityAccess: Sensitivity.Medium, }, },
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'rootDirectory', permission: { read, write, sensitivityAccess: Sensitivity.High, }, },
        { propertyName: 'member', permission: { read, write, }, },
        { propertyName: 'otherLocations', permission: { read, sensitivityAccess: Sensitivity.High, }, },
        { propertyName: 'primaryLocation', permission: { read, sensitivityAccess: Sensitivity.High, }, },
