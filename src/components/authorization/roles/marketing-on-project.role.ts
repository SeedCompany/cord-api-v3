  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbInternshipEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'countryOfOrigin', permission: { read, sensitivityAccess: Sensitivity.High, }, },
        ...
        { propertyName: 'growthPlan', permission: { read, sensitivityAccess: Sensitivity.High, }, },
    ...
    new DbBaseNodeGrant<DbLanguageEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'pnp', permission: { read, sensitivityAccess: Sensitivity.High, }, },
