  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbLanguageEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'paratextRegistryId', permission: { read, sensitivityAccess: Sensitivity.Medium }, },
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'budget', permission: { read, sensitivityAccess: Sensitivity.Medium}, },
        ...
        { propertyName: 'sensitivity', permission: { read, write, sensitivityAccess: Sensitivity.Medium }, },
        { propertyName: 'tags', permission: { read, }, },
