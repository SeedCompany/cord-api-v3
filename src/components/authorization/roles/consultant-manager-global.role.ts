...
export const ConsultantManagerGlobal = new DbRole({
  name: `global:${Role.ConsultantManager}` as const,
  powers: [
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbLanguageEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'paratextRegistryId',         permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'budget',                     permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'modifiedAt',                 permission: { read, write, }, },
