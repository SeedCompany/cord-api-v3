...
export const ConsultantOnProject = new DbRole({
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbPartner>({
      ...
      properties: [
        ...
        { propertyName: 'financialReportingTypes',    permission: { read:false, write: false,  }, },
        { propertyName: 'pmcEntityCode',              permission: { read:false, write: false,  }, },
        { propertyName: 'globalInnovationsClient',    permission: { read:false, write: false,  }, },
        { propertyName: 'active',                     permission: { read:false, write: false,  }, },
        { propertyName: 'address',                    permission: { read:false, write: false,  }, },
        { propertyName: 'modifiedAt',                 permission: { read,       write,         }, },
    ]}),
