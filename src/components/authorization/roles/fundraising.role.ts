  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbLanguage>({
      ...
      properties: [
        ...
        { propertyName: 'registryOfDialectsCode',     permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'signLanguageCode',           permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'sponsorEstimatedEndDate',    permission: { read, }, },
        { propertyName: 'ethnologue',                 permission: { read, sensitivityLevel: Sensitivity.Medium }, },
    ...
    new DbBaseNodeGrant<DbOrganization>({
      ...
      properties: [
        { propertyName: 'name',                       permission: { read, sensitivityLevel: Sensitivity.Medium }, },
    ...
    new DbBaseNodeGrant<DbPartner>({
      ...
      properties: [
        { propertyName: 'organization',               permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'pointOfContact',             permission: { read, }, },
        { propertyName: 'types',                      permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'financialReportingTypes',    permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'pmcEntityCode',              permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'globalInnovationsClient',    permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'active',                     permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'address',                    permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'modifiedAt',                 permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        ],
    canDelete: false,
  }),
    new DbBaseNodeGrant<DbPartnership>({
      ...
      properties: [
        ...
        { propertyName: 'organization',               permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'partner',                    permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        ],
    canDelete: false,
  }),
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'otherLocations',             permission: { read, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'primaryLocation',            permission: { read, sensitivityLevel: Sensitivity.Medium }, },
