  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbLanguage>({
      ...
      properties: [
        ...
        { propertyName: 'registryOfDialectsCode',     permission: { read, sensitivityLevel: Sensitivity.Low }, },
        { propertyName: 'name',                       permission: { read, }, },
        { propertyName: 'signLanguageCode',           permission: { read, sensitivityLevel: Sensitivity.Low }, },
        { propertyName: 'sponsorEstimatedEndDate',    permission: { read, }, },
        { propertyName: 'ethnologue',                 permission: { read, sensitivityLevel: Sensitivity.Low }, },
        { propertyName: 'name',                       permission: { read, }, },
        { propertyName: 'sensitivity',                permission: { read, }, },
        { propertyName: 'hasExternalFirstScripture',  permission: { read, }, },
        { propertyName: 'locations',                  permission: { read, sensitivityLevel: Sensitivity.Low }, },
    ...
    new DbBaseNodeGrant<DbOrganization>({
      ...
      properties: [
        { propertyName: 'name',                       permission: { read, sensitivityLevel: Sensitivity.Low }, },
    ...
    new DbBaseNodeGrant<DbPartner>({
      ...
      properties: [
        { propertyName: 'organization',               permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'pointOfContact',             permission: { read, }, },
        { propertyName: 'types',                      permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'financialReportingTypes',    permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'pmcEntityCode',              permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'globalInnovationsClient',    permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'active',                     permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'address',                    permission: { read, sensitivityLevel: Sensitivity.Low}, },
        { propertyName: 'modifiedAt',                 permission: { read, sensitivityLevel: Sensitivity.Low}, },
        ],
    canDelete: false,
  }),
    new DbBaseNodeGrant<DbPartnership>({
      ...
      properties: [
        ...
        { propertyName: 'organization',               permission: { read, sensitivityLevel: Sensitivity.Low }, },
        { propertyName: 'partner',                    permission: { read, sensitivityLevel: Sensitivity.Low }, },
        ],
    canDelete: false,
  }),
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'otherLocations',             permission: { read, sensitivityLevel: Sensitivity.Low }, },
        { propertyName: 'primaryLocation',            permission: { read, sensitivityLevel: Sensitivity.Low }, },
