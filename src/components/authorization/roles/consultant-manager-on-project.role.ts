  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbLanguageEngagement>({
      ...
      properties: [
        ...
        { propertyName: 'paratextRegistryId', permission: { read, write, sensitivityAccess: Sensitivity.High, }, },
    ...
    new DbBaseNodeGrant<DbProject>({
      ...
      properties: [
        ...
        { propertyName: 'budget', permission: { read, sensitivityAccess: Sensitivity.High }, },
        { propertyName: 'modifiedAt', permission: { read, }, },
