...
export const ProjectManagerGlobal = new DbRole({
  name: `global:${Role.ProjectManager}` as const,
  powers: [
    Powers.CreateBudget,
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbFileVersion>({
      ...
      properties: [
        ...
        { propertyName: 'createdBy', permission: { read, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'parent', permission: { read, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'mimeType', permission: { read, sensitivityAccess: Sensitivity.Medium, }, },
        { propertyName: 'size', permission: { read, sensitivityAccess: Sensitivity.Medium, }, },
      ],
      canDelete: false,
    }),
