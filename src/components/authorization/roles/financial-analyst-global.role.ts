...
export const FinancialAnalyst = new DbRole({
  ...
  grants: [
    ...
    new DbBaseNodeGrant<DbOrganization>({
      ...
      properties: [
        { propertyName: 'name',                       permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'address',                    permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
        { propertyName: 'locations',                  permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
        ],
    canDelete: false,
  }),
    new DbBaseNodeGrant<DbPartner>({
      ...
      properties: [
        ...
        { propertyName: 'pointOfContact',             permission: { read, write, sensitivityLevel: Sensitivity.Medium }, },
