...
} from '../../engagement/model';import { DbEthnoArt } from '../../ethno-art/model';
...
export const RegionalDirectorOnProject = new DbRole({
  name: `project:${Role.RegionalDirector}` as const,
  powers: [
    Powers.CreateBudget,
