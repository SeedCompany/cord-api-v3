...
> {
  ...
  async create(input: CreateBudgetLineItem): Promise<ID> {
    ...
    await this.db.insert(budgetLineItems).values({
      ...
      partnerAccountName: input.partnerAccountName ?? null,
      partnerAccountNumber: input.partnerAccountNumber ?? null,
  ...
  async update(
    ...
    await this.updateColumns(id, {
      ...
      partnerAccountName: changes.partnerAccountName,
      partnerAccountNumber: changes.partnerAccountNumber,
  ...
  protected toDto(
    ...
    const dto: unknown = {
      ...
      partnerAccountName: row.partnerAccountName,
