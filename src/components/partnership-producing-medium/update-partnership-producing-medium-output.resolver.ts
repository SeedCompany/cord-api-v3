...
import { PartnershipProducingMediumUpdated } from './dto/partnership-producing-medium.dto';

@Resolver(PartnershipProducingMediumUpdated)
export class UpdatePartnershipProducingMediumOutputResolver {
  @ResolveField(() => LanguageEngagement)
  engagement(
    @Parent() output: PartnershipProducingMediumUpdated,
