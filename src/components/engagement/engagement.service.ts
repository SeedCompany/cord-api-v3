...
import { transformEngagementFromRepositoryToDTO } from './engagement.transformers';
import {
...
export class EngagementService {
  ...
  async readOne(
    ...
    // TODO: this would work better early in the request handling pipeline.
    //       Call could set session.userId to anon user if it is null.
    //       It could always be assumed to exist and remove the duplicate logic.
    if (!session.userId) {
