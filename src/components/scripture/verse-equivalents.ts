import { Book, mergeVerseRanges, type Verse, type VerseLike } from '@seedcompany/scripture';
...
export const getTotalVerseEquivalents = (...refs: ReadonlyArray<Range<VerseLike>>) => {
...
export const getVerseEquivalentsFromUnspecified = (portion: UnspecifiedScripturePortion) => {
