...
export class ProjectChanges extends OmitType(UpdateProject, [
  ...
  readonly primaryLocationId?: ID<'Location'> | null;
  readonly marketingLocationId?: ID<'Location'> | null;
  readonly marketingRegionOverrideId?: ID<'Location'> | null;
  readonly fieldRegionId?: ID<'FieldRegion'> | null;
}
