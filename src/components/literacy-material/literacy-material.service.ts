...
export class LiteracyMaterialService {
  ...
  async createIndexes() {
    return [
      'CREATE CONSTRAINT IF NOT EXISTS ON (n:LiteracyMaterial) ASSERT EXISTS(n.id)',
      'CREATE CONSTRAINT IF NOT EXISTS ON (n:LiteracyMaterial) ASSERT n.id IS UNIQUE',

      'CREATE CONSTRAINT IF NOT EXISTS ON (n:LiteracyMaterial) ASSERT EXISTS(n.createdAt)',
      ...
      'CREATE CONSTRAINT IF NOT EXISTS ON (n:LiteracyName) ASSERT EXISTS(n.value)',
      'CREATE CONSTRAINT IF NOT EXISTS ON (n:LiteracyName) ASSERT n.value IS UNIQUE',
    ];
  }
