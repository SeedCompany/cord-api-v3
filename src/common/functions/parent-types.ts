...
import type { IntersectTypes } from '~/common/graphql';

/**
 * Returns a list of all the parent class types including the given one.
 */
export function getParentTypes(
  type: AbstractClass<unknown>,
  types: ReadonlyArray<AbstractClass<unknown>> = [type],
): ReadonlyArray<AbstractClass<unknown>> {
