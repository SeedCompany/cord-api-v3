...
export const periodicReports = pgTable(
  'periodic_reports',
  {
    ...
    updatedAt: timestamp('updated_at', { withTimezone: true })
      .notNull()
      .defaultNow(),
    // Soft delete, matching Neo4j's `deleteBaseNode` relabel (migration 0034).
  ...
  (t) => [
    ...
    // would silently enforce nothing. @see migration 0034
 ...
 * change. App-level `@IsIn` remains the gate. See migration 0035.
 */
 ...
 * faithful to Neo4j (see migration 0035 for the promotion candidate).
 */
