 ...
 * to stay out of its way — both the automatic migration and the root-object
 * setup. A startup write that lands after the command has already rebuilt the
 * schema collides with the rows being loaded.
 *
