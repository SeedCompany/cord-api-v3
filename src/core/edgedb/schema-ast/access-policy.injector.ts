...
import { EdgeDBAccessPolicyGenerator } from '../../../components/authorization/policy/edgedb-access-policy.generator';
import { SchemaType } from './ast-nodes';
import { CrudeAstParser } from './crude-ast-parser';
import { SchemaFile } from './schema-file';

@Injectable()
export class EdgeDBAccessPolicyInjector {
  constructor(
    private readonly resources: ResourcesHost,
    private readonly parser: CrudeAstParser,
    private readonly generator: EdgeDBAccessPolicyGenerator,
  ) {}
