...
insert into sc.partners_data(id, active,point_of_contact,organization, pmc_entity_code, types)values(0,true,0,'defaultOrg', 'default_code', ['A', 'B']);
...
-- languages_locations
insert into sc.language_locations_data(ethnologue,location) values(0,0);
