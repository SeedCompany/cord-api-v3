...
ParameterBag.prototype.addParam = function addParam(
  ...
  return value instanceof Variable ? value : origAddParam.call(this, value, name);
};

Pattern.prototype.setExpandedConditions = function (this: Pattern, expanded: boolean) {
  if (this.useExpandedConditions !== expanded) {
    ...
    if (!expanded && Object.values(this.conditions).some((cond) => cond instanceof Variable)) {
      return;
    }
