CREATE MIGRATION m1ug7fmsnii32dihklz6p7q44l7kzfsnnqwizwibg2alm5vulwho7q
    ONTO m1kzwpoy3r3awvbzqxxzz3upkkemxjtf33ra53zkuxzexsc7r5x4zq
{
  ALTER TYPE File::Node {
      CREATE LINK container: default::Resource {
          ...
          SET REQUIRED USING (<default::Resource>{});
      };
      EXTENDING Mixin::Embedded,
      Mixin::Owned LAST;
  ...
  ALTER TYPE default::File {
      ...
      CREATE LINK latestVersion: File::Version {
          CREATE REWRITE
              INSERT 
              USING (SELECT
