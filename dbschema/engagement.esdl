...
#       default := .endDate; # TODO not implemented yet
      rewrite update using (.endDate if .status = Engagement::Status.InDevelopment else .initialEndDate);
    };
...
module Engagement {
  ...
  abstract type Ceremony extending default::Resource {
    ...
    single property sensitivity := .<ceremony[is default::Engagement].sensitivity;
  }
